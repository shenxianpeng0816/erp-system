...
export const MP = {
  ...
  /** @deprecated use orderApproveFinance / orderApproveAdmin */
  orderApprove: 'erp:order:approve',
  orderApproveFinance: 'erp:order:approve:finance',
  orderApproveAdmin: 'erp:order:approve:admin',
...
export function canOpenOrderDetail(user: AuthUser | null | undefined): boolean {
  return hasAnyPermi(
    ...
    MP.orderSubmit,
    MP.orderApprove,
    MP.orderApproveFinance,
    MP.orderApproveAdmin,
    MP.orderCancel,
    MP.orderConfirm,
    MP.orderPending,
  );
